...
<?php include 'app/views/parts/header.php' ?>
  ...
  <div id="main">
    ...
    <div class="sectionfilm"><a href="app/views/parts/single.php?film_id=<?php echo $film['film_id'];?>" class="livepreview"><img src="public/asset/image/<?php echo $film['film_photo_url']; ?>"></a> </div>
    <?php endforeach ?>
